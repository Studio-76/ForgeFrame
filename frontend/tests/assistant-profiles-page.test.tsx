...
vi.mock("../src/api/admin/assistant-profiles", async () => {
  const actual = await vi.importActual<typeof import("../src/api/admin/assistant-profiles")>("../src/api/admin/assistant-profiles");
  return {
    ...actual,
