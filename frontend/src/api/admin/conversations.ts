/**
 * Conversation management API functions and types.
 *
 * (Inbox API functions live in `admin/inbox.ts` — this file was previously
 * a combined module; the duplicate inbox functions were removed in T9.)
 *
