...
- Hermes Provider-ID: `alibaba`
- Anzeige: Alibaba Cloud / DashScope
- Typ: OpenAI-kompatibel oder Anthropic-kompatibel je Base
...
Override `DASHSCOPE_BASE_URL`; Kommentare nennen auch `/apps/anthropic`.
