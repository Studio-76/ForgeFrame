...
- Hermes Provider-ID: `kimi-coding`
- Anzeige: Kimi / Moonshot
- Typ: OpenAI-kompatibel
- Base URL: `https://api.moonshot.ai/v1 oder https://api.kimi.com/coding/v1`
- Auth: KIMI_API_KEY
...
`sk-kimi-` Keys routen ohne Override automatisch auf Kimi Code Endpoint.
