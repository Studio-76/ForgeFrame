...
- Hermes Provider-ID: `zai`
- Anzeige: Z.AI / GLM
- Typ: OpenAI-kompatibel
- Base URL: `https://api.z.ai/api/paas/v4 oder China/Coding-Varianten`
- Auth: GLM_API_KEY, ZAI_API_KEY, Z_AI_API_KEY
...
Hermes probt vier Endpoints und cached den funktionierenden Endpoint pro Key-Hash.
