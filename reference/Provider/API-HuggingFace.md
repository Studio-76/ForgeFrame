...
- Hermes Provider-ID: `huggingface`
- Anzeige: Hugging Face Inference Providers
- Typ: OpenAI-kompatibler Router
...
Hermes behandelt HuggingFace-Modellnamen als authoritative native provider.
