...
- Hermes Provider-ID: `ollama`
- Anzeige: Ollama lokal
- Typ: OpenAI-kompatibel
- Base URL: `http://localhost:11434/v1 bzw. base http://localhost:11434`
- Auth: meist kein Token lokal
...
code-proxy Modell `ollama/llama3.3`; hermes alias `ollama` wird als `custom` behandelt.
...
## Offizielle Dokumentationsanreicherung: `OpenAI/API/Ollama`
...
- Original-URL: https://docs.ollama.com/api/openai-compatibility
- Bereinigte Download-URL: https://docs.ollama.com/api/openai-compatibility
- Lokale Datei(en): HTML: `openai-compatibility.html`, Text: `openai-compatibility.txt`
- Abrufdatum: `2026-04-24T05:05:37.927618+02:00`
- Zweck: Ollama OpenAI compatibility
...
<details>
<summary>Textanlage: <code>OpenAI/API/Ollama/openai-compatibility.txt</code></summary>
