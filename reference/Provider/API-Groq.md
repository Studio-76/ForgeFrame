...
- Hermes Provider-ID: `groq`
- Anzeige: Groq
- Typ: OpenAI-kompatibel
- Base URL: `https://api.groq.com/openai/v1 bzw. code-proxy base https://api.groq.com/openai`
- Auth: Bearer API key
...
code-proxy generisch; Modelle z.B. `groq/llama-3.3-70b-versatile`.
...
## Offizielle Dokumentationsanreicherung: `OpenAI/API/Groq`
...
- Original-URL: https://console.groq.com/docs/openai
- Bereinigte Download-URL: https://console.groq.com/docs/openai
- Lokale Datei(en): HTML: `openai.html`, Text: `openai.txt`
- Abrufdatum: `2026-04-24T05:05:37.927618+02:00`
- Zweck: Groq OpenAI compatibility
...
- Quelle: Pflichtquelle
- Original-URL: https://console.groq.com/docs/api-reference
- Bereinigte Download-URL: https://console.groq.com/docs/api-reference
- Lokale Datei(en): HTML: `api-reference.html`, Text: `api-reference.txt`
- Abrufdatum: `2026-04-24T05:05:37.927618+02:00`
- Zweck: Groq API reference
- Download-Werkzeug: `urllib`
- HTTP-Status: `200`
- Inhaltstyp: `text/html; charset=utf-8`
- Hinweise: Seite wirkt teilweise clientseitig gerendert; Snapshot ist best effort.
...
- `https://api.groq.com/openai/v1/batches/batch_01jh6xa7reempvjyh6n3yst2zw/cancel`
...
- `POST https://api.groq.com/openai/v1/batches/batch_01jh6xa7reempvjyh6n3yst2zw/cancel`
- `https://api.groq.com/openai/v1/files`
- `https://api.groq.com/openai/v1/files"`
- `https://api.groq.com/openai/v1/files/{file_id}`
- `DELETE https://api.groq.com/openai/v1/files/file_01jh6x76wtemjr74t1fh0faj5t`
- `https://api.groq.com/openai/v1/files/file_01jh6x76wtemjr74t1fh0faj5t`
...
endpoints
ChatCreate chat completionResponses (beta)Create responseAudioCreate transcriptionCreate translationCreate speechModelsList modelsRetrieve modelBatchesCreate batchRetrieve batchList batchesCancel batchFilesUpload fileList filesDelete fileRetrieve fileDownload fileFine TuningList fine tuningsCreate fine tuningGet fine tuningDelete fine tuning
...
Deprecated: Use search_settings.include_domains instead.
...
Tools & Integrations
Tool UseOverviewGroq Built-In ToolsWeb SearchVisit WebsiteBrowser AutomationCode ExecutionWolfram AlphaBrowser Search (GPT OSS Models)Remote Tools and MCPConnectorsLocal Tool CallingIntegrations CatalogCoding with GroqFactory DroidOpenCodeKilo CodeRoo CodeCline
...
Compound (Agentic AI)
OverviewBuilt-In ToolsSystemsUse Cases
Guides
...
<details>
<summary>Textanlage: <code>OpenAI/API/Groq/api-reference.txt</code></summary>
...
...[gekürzt in diesem Bundle: 16937 weitere Zeichen in der Quelldatei]
````
...
<details>
<summary>Textanlage: <code>OpenAI/API/Groq/openai.txt</code></summary>
...
<details>
<summary>VOLLSTÄNDIGE ungekürzte Textanlage: <code>OpenAI/API/Groq/api-reference.txt</code></summary>
