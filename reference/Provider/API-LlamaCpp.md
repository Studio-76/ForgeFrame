...
## Offizielle Dokumentationsanreicherung: `OpenAI/API/LlamaCpp`
...
- Original-URL: https://raw.githubusercontent.com/ggml-org/llama.cpp/master/tools/server/README.md
- Bereinigte Download-URL: https://raw.githubusercontent.com/ggml-org/llama.cpp/master/tools/server/README.md
- Lokale Datei(en): Markdown: `tools-server-readme.md`
- Abrufdatum: `2026-04-24T05:05:37.927618+02:00`
- Zweck: llama.cpp server README
...
- `https://github.com/ggml-org/llama.cpp/issues/1437<br/`
...
- `https://github.com/ggml-org/llama.cpp/blob/5fd160bbd9d70b94b5b11b0001fd7f477005e4a0/tools/mtmd/mtmd.h#L87`
...
- `https://github.com/ggml-org/llama.cpp/pull/18994`
...
- `https://github.com/ggml-org/llama.cpp/pull/10175`
...
- `/models_directory`
- `/my-models.ini`
- `/my-models/draft.gguf`
- `/Users/abc/my-models/draft.gguf`
- `/infill`
- `/models/load`
- `/models/unload`
- `GET /models`
...
<details>
<summary>Textanlage: <code>OpenAI/API/LlamaCpp/tools-server-readme.md</code></summary>
...
`n_cache_reuse`: Min chunk size to attempt reusing from the cache via KV shifting. For more info, see `--cache-reuse` arg. Default: `0`, wh

...[gekürzt in diesem Bundle: 46934 weitere Zeichen in der Quelldatei]
````
...
<details>
<summary>VOLLSTÄNDIGE ungekürzte Textanlage: <code>OpenAI/API/LlamaCpp/tools-server-readme.md</code></summary>
